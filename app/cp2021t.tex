...
\\\hline
a82044 & João Domingos Pereira Barbosa (preencher)
\\
a84540 & Maria João da Silva Cruz Saraiva Moreira (preencher)
\\
a64671 & João Guilherme Rodrigues Reis (preencher)
\end{tabular}
\end{center}
...
\start
        ...
        \ensuremath{\begin{lcbr}\Varid{inExpAr}\comp \Varid{outExpAr}\mathrel{=}\Varid{id}\\\Varid{outExpAr}\comp \Varid{inExpAr}\mathrel{=}\Varid{id}\end{lcbr}}
        

\just\equiv{ inExpAr = [ const X, [ N,[ bin, Ûn] ] ] }

        \ensuremath{\begin{lcbr}[\mskip1.5mu \underline{\Conid{X}},[\mskip1.5mu \Conid{N},[\mskip1.5mu \Varid{bin},\Conid{Ûn}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu]\comp \Varid{outExpAr}\mathrel{=}\Varid{id}\\\Varid{outExpAr}\comp [\mskip1.5mu \underline{\Conid{X}},[\mskip1.5mu \Conid{N},[\mskip1.5mu \Varid{bin},\Conid{Ûn}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu]\mathrel{=}\Varid{id}\end{lcbr}}
...
\just\equiv { universal-+ }
      ...
      \ensuremath{\begin{lcbr}\Varid{id}\comp i_1\mathrel{=}\Varid{outExpAr}\comp \underline{\Conid{X}}\\\Varid{id}\comp i_2\mathrel{=}[\mskip1.5mu \Varid{outExpAr}\comp \Conid{N},[\mskip1.5mu \Varid{outExpAr}\comp \Varid{bin},\Varid{outExpAr}\comp \Conid{Ûn}\mskip1.5mu]\mskip1.5mu]\end{lcbr}}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{k1}\;(i_1\;())\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1});{}\<[E]%
\\
\>[B]{}\Varid{k1}\;(i_2\;(i_1\;(\Varid{a})))\mathrel{=}(\Conid{N}\;\Varid{a},\Conid{N}\;\mathrm{0});{}\<[E]%
\\
\>[B]{}\Varid{k1}\;(i_2\;(i_2\;(i_1\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{d})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{c}));{}\<[E]%
\\
\>[B]{}\Varid{k1}\;(i_2\;(i_2\;(i_1\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{c},\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{d});{}\<[E]%
\\
\>[B]{}\Varid{k1}\;(i_2\;(i_2\;(i_2\;(\Conid{Negate},(\Varid{a},\Varid{b})))))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{a},\Conid{Un}\;\Conid{Negate}\;\Varid{b});{}\<[E]%
\\
\>[B]{}\Varid{k1}\;(i_2\;(i_2\;(i_2\;(\Conid{E},(\Varid{a},\Varid{b})))))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{a},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\;\Varid{b});{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\Varid{k1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 t}\;\Varid{n}\;(i_1\;())\mathrel{=}(\Varid{n},\mathrm{1});{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 t}\;\Varid{n}\;(i_2\;(i_1\;(\Varid{a})))\mathrel{=}(\Varid{a},\mathrm{0});{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 t}\;\Varid{n}\;(i_2\;(i_2\;(i_1\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}((\Varid{a}\mathbin{*}\Varid{c}),(\Varid{a}\mathbin{*}\Varid{d})\mathbin{+}(\Varid{b}\mathbin{*}\Varid{c}));{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 t}\;\Varid{n}\;(i_2\;(i_2\;(i_1\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d});{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 t}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{Negate},(\Varid{a},\Varid{b})))))\mathrel{=}((\mathbin{-}\mathrm{1})\mathbin{*}(\Varid{a}),(\mathbin{-}\mathrm{1})\mathbin{*}(\Varid{b}));{}\<[E]%
\\
\>[B]{}\Varid{ad\char95 t}\;\Varid{n}\;(i_2\;(i_2\;(i_2\;(\Conid{E},(\Varid{a},\Varid{b})))))\mathrel{=}((\Varid{expd}\;\Varid{a}),(\Varid{expd}\;\Varid{a})\mathbin{*}\Varid{b});{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{v}\mathrel{=}\Varid{ad\char95 t}\;\Varid{v};{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{t},\Varid{h},\Varid{s},\Varid{p})\mathrel{=}(\Varid{c}\mathbin{*}\Varid{t}\div \Varid{h},\Varid{t}\mathbin{+}\Varid{s},\Varid{h}\mathbin{+}\Varid{p},\Varid{s}\mathbin{+}\mathrm{8},\Varid{p}\mathbin{+}\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2},\mathrm{10},\mathrm{4}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{c},\Varid{t},\Varid{h},\Varid{s},\Varid{p})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\>[B]{}\Varid{calcLine}\mathbin{::}\Conid{NPoint}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\Varid{calcLine}\mathrel{=}\Varid{cataList}\;\alt{\underline{\underline{\Varid{nil}}}}{\Varid{k}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{k}\;(\Varid{d},\Varid{f})\;[\mskip1.5mu \mskip1.5mu]\;\Varid{f1}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{k}\;(\Varid{d},\Varid{f})\;(\Varid{x}\mathbin{:}\Varid{xs})\;\Varid{f1}\mathrel{=}\Varid{linear1d}\;\Varid{d}\;\Varid{x}\;\Varid{f1}\mathbin{:}\Varid{f}\;\Varid{xs}\;\Varid{f1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{data}\;\Conid{FAlgForm}\;\Varid{a}\mathrel{=}\Conid{Empty}\mid \Conid{Only}\;(\Varid{a})\mid \Conid{Pair}\;(\Conid{FAlgForm}\;\Varid{a})\;(\Conid{FAlgForm}\;\Varid{a}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{outAlg}\;\Conid{Empty}\mathrel{=}i_1\;();{}\<[E]%
\\
\>[B]{}\Varid{outAlg}\;\Conid{Only}\;(\Varid{a})\mathrel{=}(i_2\comp i_1)\;\Varid{a};{}\<[E]%
\\
\>[B]{}\Varid{outAlg}\;\Conid{Pair}\;(\Varid{x},\Varid{y})\mathrel{=}(i_2\comp i_2)\;(\Varid{x},\Varid{y});{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataAlgForm}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Conid{FAlgForm}\;\cata{\cdot }\comp \Varid{outAlg}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inAlg}\mathrel{=}\alt{\Conid{Empty}}{\alt{\Conid{Only}}{\Conid{Pair}}}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{b}\mathrel{=}\underline{(\mathrm{0},\mathrm{0})};{}\<[E]%
\\
\>[B]{}\Varid{q}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{a}\mathbin{+}(\Varid{mul}\;(\Varid{b},\Varid{c}))\div \Varid{c}\mathbin{+}\mathrm{1},\Varid{c}\mathbin{+}\mathrm{1});{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataList}\;\alt{\Varid{b}}{\Varid{q}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
