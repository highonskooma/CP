...
Sabemos que both pode ser definida como \ensuremath{\Varid{both}\mathrel{=}\llparenthesis\, \Varid{gene}\,\rrparenthesis} onde o gene é \ensuremath{\alt{\Varid{f}}{\Varid{g}}}, isto é uma alternativa.\\
...
\\
\>[B]{}\Varid{both}\mathrel{=}\llparenthesis\, \alt{\Varid{f}}{\Varid{g}}\,\rrparenthesis\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{f}\;\Varid{x}\mathrel{=}(\Varid{x},\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{g}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{max}\;\Varid{b}\;\Varid{d},\Varid{min}\;\Varid{a}\;\Varid{c}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{alice}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{alice}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\Varid{max}\;(\Varid{bob}\;\Varid{x})\;(\Varid{bob}\;\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{bob}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{bob}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\Varid{min}\;(\Varid{alice}\;\Varid{x})\;(\Varid{alice}\;\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
    \ensuremath{\mathbf{in}\mathrel{=}\alt{\Conid{Leaf}}{\Conid{Fork}}} \\
    \ensuremath{\Conid{F}\;\Conid{X}\mathrel{=}\Conid{A}\mathbin{+}} {X^2} \\
    \ensuremath{\Conid{F}\;\Varid{f}\mathrel{=}\Varid{id}\mathbin{+}} {f^2} 

\end{eqnarray*}

Sabemos que \ensuremath{\Varid{both}\mathrel{=}\conj{\Varid{alice}}{\Varid{bob}}} e pela lei de recursividade mutua sabemos que 
\ensuremath{\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\cata{\conj{\Varid{h}}{\Varid{k}}}} \\
Agora, a partir de Alice e Bob é possivel encontrarmos os seus genes respectivamente, h e k para definirmos \ensuremath{\Varid{both}\mathrel{=}\cata{\conj{\Varid{h}}{\Varid{k}}}}
...
\begin{eqnarray*}
    \begin{cases} 
        \ensuremath{h_1 \;\Varid{x}\mathrel{=}\Varid{id}\;\Varid{x}}\\
        \ensuremath{h_2 \;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\uncurry{\Varid{max}}\comp \conj{\p2\comp \p1}{\p2\comp \p2})\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}\Varid{max}\;\Varid{b}\;\Varid{d}}
    \end{cases}
\end{eqnarray*}
E chegamos também ao gene k=[k1,k2] do catamorfismo bob\\
\begin{eqnarray*}
    \begin{cases} 
        \ensuremath{k_1 \;\Varid{x}\mathrel{=}\Varid{id}\;\Varid{x}}\\
        \ensuremath{k_2 \;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\uncurry{\Varid{min}}\comp \conj{\p1\comp \p1}{\p1\comp \p2})\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}\Varid{min}\;\Varid{a}\;\Varid{c}}
    \end{cases}
\end{eqnarray*}
...
\>[B]{}\Varid{both'}\mathbin{::}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{both'}\mathrel{=}\llparenthesis\, \conj{\Varid{h}}{\Varid{k}}\,\rrparenthesis\;{}\<[32]%
\>[32]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h}\mathrel{=}\alt{h_1 }{h_2 }\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}h_1 \;\Varid{x}\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}h_2 \;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}\Varid{max}\;\Varid{b}\;\Varid{d}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{k}\mathrel{=}\alt{k_1 }{k_2 }\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}k_1 \;\Varid{x}\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}k_2 \;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}\Varid{min}\;\Varid{a}\;\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inLTree3}\mathrel{=}\alt{\Conid{Tri}}{\Varid{f}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{f}\;((\Varid{a},\Varid{b}),\Varid{c})\mathrel{=}\Conid{Nodo}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}g_1 \mathrel{=}\alt{\Varid{h}}{\Varid{k}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h}\;\Varid{x}\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{k}\;(([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{b}\mskip1.5mu]),\Varid{c})\mathrel{=}\Varid{a}\mathbin{:}\Varid{b}\mathbin{:}\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{k}\;((\Varid{a}\mathbin{:}\Varid{as},\Varid{b}\mathbin{:}\Varid{bs}),\Varid{c})\mathrel{=}\Varid{a}\mathbin{:}\Varid{b}\mathbin{:}\Varid{k}\;((\Varid{as},\Varid{bs}),\Varid{c}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t1}\mathrel{=}(((\Varid{x},\Varid{y}),\Varid{s}\div \mathrm{2}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t2}\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{s}\div \mathrm{2}),\Varid{s}\div {}\<[35]%
\>[35]{}\mathrm{2}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t3}\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{s}\div \mathrm{2},\Varid{y}),\Varid{s}\div \mathrm{2}),\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newpage
\subsection*{Problema 4}
