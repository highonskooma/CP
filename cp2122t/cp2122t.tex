...
\start
\\
    \ensuremath{\mathbf{in}\mathrel{=}\alt{\Varid{zero}}{\succ }} \\
...
\begin{eqnarray*}
\start
\begin{cases} \ensuremath{\Varid{q}\comp \mathbf{in}\mathrel{=}\Varid{h}\comp \Conid{F}\;\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}} \\ 
    \ensuremath{\Varid{r}\comp \mathbf{in}\mathrel{=}\Varid{k}\comp \Conid{F}\;(\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}} \\
    \ensuremath{\Varid{c}\comp \mathbf{in}\mathrel{=}\Varid{l}\comp \Conid{F}\;(\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}} \end{cases}
%
\just\equiv{ \ensuremath{\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}\mathrel{=}\cata{\conj{\Varid{h}}{\conj{\Varid{k}}{\Varid{l}}}}} }
%
\just\equiv{ Definição de in, Funtor dos Naturais }
%
\begin{cases} \ensuremath{\Varid{q}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\Varid{h}\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}})} \\ 
    \ensuremath{\Varid{r}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\Varid{k}\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}})} \\
    \ensuremath{\Varid{c}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\Varid{l}\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}})} \end{cases}
%
\just\equiv{ Fusão-+ }
%
\begin{cases} \ensuremath{\alt{\Varid{q}\comp \Varid{zero}}{\Varid{q}\comp \succ }\mathrel{=}\alt{h_1 }{h_2 }\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}})} \\ 
    \ensuremath{\alt{\Varid{r}\comp \Varid{zero}}{\Varid{r}\comp \succ }\mathrel{=}\alt{k_1 }{k_2 }\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}})} \\
    \ensuremath{\alt{\Varid{c}\comp \Varid{zero}}{\Varid{c}\comp \succ }\mathrel{=}\alt{l_1 }{l_2 }\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}})} \end{cases}
%
\just\equiv{ Absorção-+}
%
\begin{cases} \ensuremath{\alt{\Varid{q}\comp \Varid{zero}}{\Varid{q}\comp \succ }\mathrel{=}\alt{h_1 \comp \Varid{id}}{h_2 \comp \conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}}} \\ 
    \ensuremath{\alt{\Varid{r}\comp \Varid{zero}}{\Varid{r}\comp \succ }\mathrel{=}\alt{k_1 \comp \Varid{id}}{k_2 \comp \conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}}} \\
    \ensuremath{\alt{\Varid{c}\comp \Varid{zero}}{\Varid{c}\comp \succ }\mathrel{=}\alt{l_1 \comp \Varid{id}}{l_2 \comp \conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}}} \end{cases}
%
\just\equiv{ EQ-+ }
%
\begin{cases}
    \begin{cases}
	    \ensuremath{\Varid{q}\comp \Varid{zero}\mathrel{=}h_1 \comp \Varid{id}}\\
        \ensuremath{\Varid{q}\comp \succ \mathrel{=}h_2 \comp \conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}} 
    \end{cases} \\
    \begin{cases}
        \ensuremath{\Varid{r}\comp \Varid{zero}\mathrel{=}k_1 \comp \Varid{id}}\\ 
        \ensuremath{\Varid{r}\comp \succ \mathrel{=}k_2 \comp \conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}} 
    \end{cases} \\
    \begin{cases}
        \ensuremath{\Varid{c}\comp \Varid{zero}\mathrel{=}l_1 \comp \Varid{id}}\\
...
\begin{cases}
    \begin{cases}
	    \ensuremath{(\Varid{q}\comp \Varid{zero})\;\Varid{x}\mathrel{=}(h_1 \comp \Varid{id})\;\Varid{x}}\\
        \ensuremath{(\Varid{q}\comp \succ )\;\Varid{x}\mathrel{=}(h_2 \comp \conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}})\;\Varid{x}} 
    \end{cases} \\
    \begin{cases}
        \ensuremath{(\Varid{r}\comp \Varid{zero})\;\Varid{x}\mathrel{=}(k_1 \comp \Varid{id})\;\Varid{x}}\\ 
        \ensuremath{(\Varid{r}\comp \succ )\;\Varid{x}\mathrel{=}(k_2 \comp \conj{\Varid{q}}{\conj{\Varid{rc}}{\cdot }})\;\Varid{x}} 
    \end{cases} \\
    \begin{cases}
        \ensuremath{(\Varid{c}\comp \Varid{zero})\;\Varid{x}\mathrel{=}(l_1 \comp \Varid{id})\;\Varid{x}}\\
...
\begin{cases}
    \begin{cases}
	    \ensuremath{\Varid{q}\;(\Varid{zero}\;\Varid{x})\mathrel{=}h_1 \;(\Varid{id}\;\Varid{x})}\\
        \ensuremath{\Varid{q}\;(\succ \;\Varid{x})\mathrel{=}h_2 \;(\conj{\Varid{q}}{\conj{\Varid{r}}{\Varid{c}}}\;\Varid{x})} 
    \end{cases} \\
    \begin{cases}
        \ensuremath{\Varid{r}\;(\Varid{zero}\;\Varid{x})\mathrel{=}k_1 \;(\Varid{id}\;\Varid{x})}\\ 
        \ensuremath{\Varid{r}\;(\succ \;\Varid{x})\mathrel{=}k_2 \;(\conj{\Varid{q}}{\conj{\Varid{rc}}{\cdot }}\;\Varid{x})} 
    \end{cases} \\
    \begin{cases}
        \ensuremath{\Varid{c}\;(\Varid{zero}\;\Varid{x})\mathrel{=}l_1 \;(\Varid{id}\;\Varid{x})}\\
...
\xymatrix@C=2cm@R=2cm{
     \ensuremath{{\LTree}\;\Conid{A}}
           \ar[dr]_{\ensuremath{\Varid{alice}}}
&
     \ensuremath{{\LTree}\;\Conid{A}} 
           \ar[l]_-{\ensuremath{\Varid{id}}}
           \ar[r]^-{\ensuremath{\Varid{id}}}
           \ar[d]^-{\ensuremath{\Varid{both}}}
&
     \ensuremath{{\LTree}\;\Conid{A}}
           \ar[dl]^{\ensuremath{\Varid{bob}}}
\\
&
     \ensuremath{\Conid{INT}} \times \ensuremath{\Conid{INT}}
}
\end{eqnarray*}
...
g2 (((x,y),s),n+1) = i2((t1,t2),t3) where
     ...
     t3 = (((x+s/2,y),fromIntegral s/2),n)  \commentend}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
